          ...
          <a className="block max-w-md mx-auto group relative" href="#">
            <div className="absolute bottom-0 left-0 w-full p-5">
              <div className="p-5 bg-white rounded-xl">
                <h4 className="text-xl font-semibold">Consectures Content Velit officia consequat duis</h4>
            ...
            <img className="block w-full h-80 rounded-lg" src="https://images.unsplash.com/photo-1714891203404-b25f32706e0a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
          </a>
        </div>
